...
TICKET_PANEL_DESCRIPTION = (
    "Επίλεξε κατηγορία από το μενού παρακάτω για να ανοίξεις ένα ιδιωτικό ticket με το staff. "
    "Περιγράψε το θέμα που σε απασχολεί και θα σε βοηθήσουμε σύντομα."
)
